...
export const Pagination = ({ currentPeopleLength, peoplePerPage, totalPeopleLength, paginate, currentPage }) => {
    ...
    const indexOfLastPage = currentPage === pageNumbers.length ? currentPage : currentPage + 1;
    const indexOfFirstPage = indexOfLastPage - 5;

    const currentPageNumbers = currentPage >= 5 ? pageNumbers.slice(indexOfFirstPage, indexOfLastPage) : pageNumbers.slice(0, 5);
